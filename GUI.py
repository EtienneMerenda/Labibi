...
class ClientGUI():
    ...
    def refreshChat(self):
        if GUIDict["chatRcv"] != GUIDict["oldChatRcv"]:
            self.msgRecever["text"] += f"\n{GUIDict['chatRcv']}"
            GUIDict["oldChatRcv"] = GUIDict["chatRcv"]
